...
export default function ContactPage() {
    ...
    return (
        <MainLayout>
            <section id="contact" className="flex-1 py-24 px-6" style={{ backgroundColor: "#111111" }}>
                <div className="max-w-5xl mx-auto">
                    <div className="rounded-2xl p-12 text-center" style={{ backgroundColor: "#1C1C1C", border: "1px solid rgba(248,245,240,0.06)" }}>
                        ...
                        <div className="flex flex-wrap justify-center gap-4 mb-12">
                            <button onClick={() => navigate("/booking")} className="px-8 py-3.5 rounded-lg font-semibold text-sm transition-all hover:scale-105" style={{ backgroundColor: "#C9A96E", color: "#111111" }}>
                                Reservar ahora
                            </button>
