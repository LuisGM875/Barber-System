      ...
      <div className="relative max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
        <div className="animate-fadeInUp">
          ...
          <div className="flex flex-wrap gap-3">
            <button onClick={() => onNavigate("booking")} className="px-8 py-3.5 rounded-lg font-semibold text-sm transition-all hover:scale-105" style={{ backgroundColor: "#C9A96E", color: "#111111" }}>
              Reservar cita
            </button>
            <button onClick={() => document.getElementById("services")?.scrollIntoView({ behavior: "smooth" })} className="px-8 py-3.5 rounded-lg font-medium text-sm border transition-all" style={{ color: "#F8F5F0", borderColor: "rgba(248,245,240,0.2)" }}
